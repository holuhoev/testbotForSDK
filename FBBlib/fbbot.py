...
class FBBot(object):
    ...
    def get_userinfo(self, user_id):
        resp = requests.get("https://graph.facebook.com/v2.6/{0}?fields=first_name,last_name,profile_pic,locale,timezone,gender&access_token={1}".format(user_id,self.access_token))
        return resp.json()
